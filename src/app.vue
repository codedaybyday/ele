...
<script>
import FooterNav from './component/index/footerNav.vue';
import IndexHeader from './component/index/indexHeader.vue';
import MerchantList from './component/index/merchantList.vue';
import FoodEntryList from './component/index/foodEntryList.vue';
export default{
	components:{
		FooterNav,
		IndexHeader,
